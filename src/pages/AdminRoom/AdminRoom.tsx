...
export function AdminRoom() {
  ...
  function handleModal(questionId: string) {
  ...
  return (
    <>
      <ModalComponent
        ...
        onRequestClose={() => setModalDeleteQuestion(false)}
      >
        <section>
          <img src={sadEmoji} alt="carinha triste" />
          <h2>Tem certeza que deseja excluir esta pergunta?</h2>
          <div>
            <Button isOutlined onClick={() => setModalDeleteQuestion(false)}>
              Cancelar
            </Button>
            <Button onClick={handleDeleteQuestion}>Sim, deletar</Button>
          </div>
        </section>
      </ModalComponent>
